 ...
 * @author Kuld
 */
public class WinFrog extends JPanel implements MouseListener{
    ...
    private ImageIcon victoriaImg = new ImageIcon(getClass().getResource("/FrogAssets/win-buttons.png"));
    private int alto = 930;
    private int ancho = 560;
    private MameFrame frame;

    public WinFrog(MameFrame frame) {
    ...
    public void paintComponent(Graphics grafico) {
        ...
        grafico.drawImage(victoriaImg.getImage(), 400, 40, 200, 40, null);
    }
